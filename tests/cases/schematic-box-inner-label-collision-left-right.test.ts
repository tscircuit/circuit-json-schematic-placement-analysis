...
test("generates a left-right inner label collision issue", async () => {
  ...
  expect(analysis.toString()).toContain(
    '<SchematicBoxTooSmall message="Inner labels are colliding. Increase the schWidth or schHeight." componentName="U2" currentSchWidth="1.25" currentSchHeight="4" overlappingSides="left,right" />',
  )
